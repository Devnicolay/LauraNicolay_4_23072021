...
function firstNameCheck() {
  ...
  if (firstName.value.trim().length >= 2) { // the value of firstName must have 2 caracters or more
...
function lastNameCheck() {
  ...
  if (lastName.value.trim().length >= 2) { // the value of lastName must have 2 caracters or more
